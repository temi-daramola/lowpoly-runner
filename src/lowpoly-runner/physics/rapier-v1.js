...
export const INIT_PHYSICS = () => {
 ...
 function syncVisualPositions() {
  for (let [mesh, data] of physicsObjects) {
    // Don't sync player - let player code control its position
    if (mesh.userData.isPlayer) {
      continue;
    }
...
/**
 * physics.js
 * Handles all Rapier physics logic for the Subway Surfer game
 *
 * This module is responsible for:
 * - Initializing the Rapier physics world
 * - Creating rigid bodies and colliders for game objects
 * - Stepping the physics simulation
 * - Detecting collisions
 * - Syncing Three.js visuals with Rapier physics
 */